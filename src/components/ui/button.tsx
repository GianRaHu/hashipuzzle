  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-white hover:bg-success/90 hover:scale-105 hover:shadow-lg",
        warning: "bg-warning text-white hover:bg-warning/90 hover:scale-105 hover:shadow-lg",
        premium: "bg-gradient-to-r from-primary to-primaryGlow text-white hover:shadow-elegant hover:scale-105",
        glass: "bg-white/10 text-white border border-white/20 hover:bg-white/20 backdrop-blur-sm hover:scale-105",
      },
      size: {
